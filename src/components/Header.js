    ...
    render={(data) => {
      ...
      return (
        <div className={'navBarWrapper'}>
          <nav className={'navbar navBarDefault rounded-none shadow border-0 flex items-center mb-0 border-t-0 p-4'}>
            <div className={'navbar-header navBarHeader w-full md:w-1/3 xl:w-1/3'}>
